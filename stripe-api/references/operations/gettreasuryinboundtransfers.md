...
**Operation ID:** `GetTreasuryInboundTransfers`
...
| `status` | query | enum: canceled, failed, processing... | No | Only return InboundTransfers that have the given status: `processing`, `succeeded`, `failed` or `canceled`. |
