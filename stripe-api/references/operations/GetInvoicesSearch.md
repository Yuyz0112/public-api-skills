...
**Search invoices**
**Operation ID:** `GetInvoicesSearch`
...
| `query` | query | string | Yes | The search query string. See [search query language](https://docs.stripe.com/search#search-query-language) and the list of supported [query fields for invoices](https://docs.stripe.com/search#query-fields-for-invoices). |
