...
**Operation ID:** `GetApplicationFees`
...
|------|------|------|----------|-------------|
| `charge` | query | string | No | Only return application fees for the charge specified by this charge ID. |
| `created` | query | any | No | Only return applications fees that were created during the given date interval. |
