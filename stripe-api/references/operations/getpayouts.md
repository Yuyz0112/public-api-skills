...
|------|------|------|----------|-------------|
| `arrival_date` | query | any | No | Only return payouts that are expected to arrive during the given date interval. |
| `created` | query | any | No | Only return payouts that were created during the given date interval. |
