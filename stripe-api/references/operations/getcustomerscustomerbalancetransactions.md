...
|------|------|------|----------|-------------|
| `created` | query | any | No | Only return customer balance transactions that were created during the given date interval. |
...
| `invoice` | query | string | No | Only return transactions that are related to the specified invoice. |
