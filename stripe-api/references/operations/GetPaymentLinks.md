...
|------|------|------|----------|-------------|
| `active` | query | boolean | No | Only return payment links that are active or inactive (e.g., pass `false` to list all inactive payment links). |
