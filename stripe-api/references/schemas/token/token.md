...
|-------|------|----------|-------------|
| `bank_account` | [bank_account](bank-account.md) | No |  |
| `card` | [card](card.md) | No |  |
...
| `object` | enum: token | Yes | String representing the object's type. Objects of the same type share the same value. |
