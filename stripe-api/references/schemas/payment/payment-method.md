...
| `custom` | [payment_method_custom](payment-method-custom.md) | No |  |
...
| `object` | enum: payment_method | Yes | String representing the object's type. Objects of the same type share the same value. |
