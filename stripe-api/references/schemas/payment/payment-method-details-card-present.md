...
| `capture_before` | integer (unix-time) | No | When using manual capture, a future timestamp after which the charge will be automatically refunded if uncaptured. |
...
| `overcapture_supported` | boolean | Yes | Defines whether the authorized amount can be over-captured or not |
