...
|-------|------|----------|-------------|
| `distinct_responder_count` | integer | No | Distinct count of responders who engaged in incidents on the escalation policy |
| `escalation_policy_id` | string | No | ID of the escalation policy the incident was last assigned to. Not included when aggregating by all. |
| `escalation_policy_name` | string | No | Name of the escalation policy the incident was last assigned to. Not included when aggregating by all. |
...
if they exist. |
| `range_start` | string | No | Start of the date range that the metrics were calculated for. Only included when an aggregate unit is specified in the request. |
| `team_id` | string | No | ID of the team the incident was assigned to. Not included when aggregating by all. |
| `team_name` | string | No | Name of the team the incident was assigned to. Not included when aggregating by all. |
