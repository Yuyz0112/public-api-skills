...
**Operation ID:** `getApiV4IssuesStatistics`
...
| `scope` | query | enum: created_by_me, assigned_to_me, all | No | Return issues for the given scope: `created_by_me`, `assigned_to_me` or `all` |
