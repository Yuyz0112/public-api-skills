...
**Operation ID:** `getApiV4ProjectsIdIssuesIssueIidAwardEmoji`
...
| `issue_iid` | path | integer | Yes | ID (`iid` for merge requests/issues/epics, `id` for snippets) of an awardable. |
