# GET /api/v4/virtual_registries/packages/maven/registries/{id}

**Resource:** [Virtual registries](../resources/Virtual-registries.md)
**Get a specific maven virtual registry**
**Operation ID:** `getApiV4VirtualRegistriesPackagesMavenRegistriesId`
