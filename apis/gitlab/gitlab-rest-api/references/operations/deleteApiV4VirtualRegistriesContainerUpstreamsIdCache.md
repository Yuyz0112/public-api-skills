# DELETE /api/v4/virtual_registries/container/upstreams/{id}/cache

**Resource:** [Virtual registries](../resources/Virtual-registries.md)
**Purge cache for a container virtual registry upstream**
**Operation ID:** `deleteApiV4VirtualRegistriesContainerUpstreamsIdCache`
