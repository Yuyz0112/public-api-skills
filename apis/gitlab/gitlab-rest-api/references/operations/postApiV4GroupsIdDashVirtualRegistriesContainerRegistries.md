# POST /api/v4/groups/{id}/-/virtual_registries/container/registries

**Resource:** [Virtual registries](../resources/Virtual-registries.md)
**Create a new container virtual registry**
**Operation ID:** `postApiV4GroupsIdDashVirtualRegistriesContainerRegistries`
