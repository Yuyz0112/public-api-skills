...
**Operation ID:** `getApiV4ProjectsIdMergeRequestsMergeRequestIidAwardEmoji`
...
| `merge_request_iid` | path | integer | Yes | ID (`iid` for merge requests/issues/epics, `id` for snippets) of an awardable. |
