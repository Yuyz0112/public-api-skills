...
**Get a single merge request resource label event**
**Operation ID:** `getApiV4ProjectsIdMergeRequestsEventableIdResourceLabelEventsEventId`
...
| `eventable_id` | path | any | Yes | The IID of the merge request |
