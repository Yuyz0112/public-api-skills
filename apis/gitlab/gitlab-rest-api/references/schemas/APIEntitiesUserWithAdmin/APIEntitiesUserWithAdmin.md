...
| `custom_attributes` | APIEntitiesCustomAttribute[] | No |  |
| `web_url` | string | No |  |
...
| `scim_identities` | [APIEntitiesScimIdentity](APIEntitiesScimIdentity.md) | No |  |
| `is_admin` | string | No |  |
| `note` | string | No |  |
| `namespace_id` | string | No |  |
| `created_by` | [APIEntitiesUserBasic](APIEntitiesUserBasic.md) | No |  |
| `using_license_seat` | string | No |  |
| `is_auditor` | string | No |  |
| `provisioned_by_group_id` | string | No |  |
| `enterprise_group_id` | string | No |  |
| `enterprise_group_associated_at` | string | No |  |
