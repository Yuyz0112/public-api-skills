...
**Operation ID:** `GetTreasuryOutboundTransfers`
...
| `status` | query | enum: canceled, failed, posted... | No | Only return OutboundTransfers that have the given status: `processing`, `canceled`, `failed`, `posted`, or `returned`. |
