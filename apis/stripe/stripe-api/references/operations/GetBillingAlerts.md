...
|------|------|------|----------|-------------|
| `alert_type` | query | enum: usage_threshold | No | Filter results to only include this type of alert. |
...
| `meter` | query | string | No | Filter results to only include alerts with the given meter. |
