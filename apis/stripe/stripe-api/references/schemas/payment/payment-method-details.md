...
| `card` | [payment_method_details_card](payment-method-details-card.md) | No |  |
...
| `mb_way` | [payment_method_details_mb_way](payment-method-details-mb-way.md) | No |  |
...
| `us_bank_account` | [payment_method_details_us_bank_account](payment-method-details-us-bank-account.md) | No |  |
...
| `zip` | [payment_method_details_zip](payment-method-details-zip.md) | No |  |
