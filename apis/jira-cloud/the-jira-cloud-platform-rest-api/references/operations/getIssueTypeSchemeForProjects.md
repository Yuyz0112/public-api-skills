...
| `projectId` | query | integer[] | Yes | The list of project IDs. To include multiple project IDs, provide an ampersand-separated list. For example, `projectId=10000&projectId=10001`. |
...
[PageBeanIssueTypeSchemeProjects](../schemas/Page/PageBeanIssueTypeSchemeProjects.md)
