...
|-------|------|----------|-------------|
| `customField` | string | Yes | The ID or key of the custom field. For example, `customfield_10010`. |
| `issueIds` | integer[] | Yes | The list of issue IDs. |
| `value` | any | Yes | The value for the custom field. The value must be compatible with the [custom field type](https://developer.atlassian.com/platform/forge/manifest-reference/modules/jira-custom-field/#data-types) as follows:
