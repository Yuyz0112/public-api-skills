...
|-------|------|----------|-------------|
| `sendBulkNotification` | boolean | No | A boolean value that indicates whether to send a bulk change notification when the issues are being moved.

If `true`, dispatches a bulk notification email to users about the updates. |
| `targetToSourcesMapping` | object | No | An object representing the mapping of issues and data related to destination entities, like fields and statuses, that are required during a bulk move.
