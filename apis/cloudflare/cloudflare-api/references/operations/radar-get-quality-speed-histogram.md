...
**Operation ID:** `radar-get-quality-speed-histogram`
...
| `bucketSize` | query | integer | No | Specifies the width for every bucket in the histogram. |
| `metricGroup` | query | enum: BANDWIDTH, LATENCY, JITTER | No | Metrics to be returned. |
