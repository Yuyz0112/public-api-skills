...
**Operation ID:** `radar-get-attacks-layer7-timeseries-group`
...
|------|------|------|----------|-------------|
| `dimension` | path | enum: HTTP_METHOD, HTTP_VERSION, IP_VERSION... | Yes | Specifies the attribute by which to group the results. |
