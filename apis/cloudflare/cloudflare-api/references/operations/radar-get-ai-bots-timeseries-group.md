...
**Resource:** [Radar AI Bots](../resources/Radar-AI-Bots.md)
**Get time series distribution of AI bots HTTP requests by dimension.**
**Operation ID:** `radar-get-ai-bots-timeseries-group`
...
|------|------|------|----------|-------------|
| `dimension` | path | enum: USER_AGENT, CRAWL_PURPOSE, INDUSTRY... | Yes | Specifies the attribute by which to group the results. |
...
| `crawlPurpose` | query | string[] | No | Filters results by bot crawl purpose. |
