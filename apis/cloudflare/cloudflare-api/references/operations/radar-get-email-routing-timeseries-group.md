...
**Operation ID:** `radar-get-email-routing-timeseries-group`
...
|------|------|------|----------|-------------|
| `dimension` | path | enum: IP_VERSION, ENCRYPTED, ARC... | Yes | Specifies the attribute by which to group the results. |
