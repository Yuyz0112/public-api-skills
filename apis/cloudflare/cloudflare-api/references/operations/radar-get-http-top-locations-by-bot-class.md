...
**Operation ID:** `radar-get-http-top-locations-by-bot-class`
...
|------|------|------|----------|-------------|
| `bot_class` | path | enum: LIKELY_AUTOMATED, LIKELY_HUMAN | Yes | Bot class. Refer to [Bot classes](https://developers.cloudflare.com/radar/concepts/bot-classes/). |
