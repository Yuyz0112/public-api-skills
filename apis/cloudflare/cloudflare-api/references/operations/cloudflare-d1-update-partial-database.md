...
**Operation ID:** `cloudflare-d1-update-partial-database`
...
**Schema:** [d1_database-update-partial-request-body](../schemas/d1/d1-database-update-partial-request-body.md)
