...
**Operation ID:** `radar-get-email-security-top-tlds-by-malicious`
...
|------|------|------|----------|-------------|
| `malicious` | path | enum: MALICIOUS, NOT_MALICIOUS | Yes | Malicious classification. |
...
| `tldCategory` | query | enum: CLASSIC, COUNTRY | No | Filters results by TLD category. |
