...
| `conclusion` | enum: action_required, cancelled, failure... | Yes |  |
...
| `display_title` | string | No | The event-specific title associated with the run or the run-name if set, or the value of `run-name` if it is set in the workflow. |
