...
| `changes` | object | Yes | The changes to the team if the action was `edited`. |
...
| `name` | object | No |  |
| `privacy` | object | No |  |
| `notification_setting` | object | No |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `from` | string | Yes | The previous version of the team's privacy if the action was `edited`. |

#### `changes.notification_setting`

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `from` | string | Yes | The previous version of the team's notification setting if the action was `edited`. |
