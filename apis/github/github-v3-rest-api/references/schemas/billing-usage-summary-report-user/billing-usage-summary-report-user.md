...
| `user` | string | Yes | The unique identifier of the user. |
| `repository` | string | No | The name of the repository for the usage report. |
| `product` | string | No | The product for the usage report. |
| `sku` | string | No | The SKU for the usage report. |
