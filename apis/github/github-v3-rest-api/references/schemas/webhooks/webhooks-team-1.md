...
| `notification_setting` | enum: notifications_enabled, notifications_disabled | No | Whether team members will receive notifications when their team is @mentioned |
