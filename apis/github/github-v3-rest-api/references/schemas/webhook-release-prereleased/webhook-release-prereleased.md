...
|-------|------|----------|-------------|
| `action` | enum: prereleased | Yes |  |
| `enterprise` | [enterprise-webhooks](enterprise-webhooks.md) | No |  |
| `installation` | [simple-installation](simple-installation.md) | No |  |
| `organization` | [organization-simple-webhooks](organization-simple-webhooks.md) | No |  |
| `release` | object | Yes | The [release](https://docs.github.com/rest/releases/releases/#get-a-release) object. |
...
| `name` | string | Yes |  |
| `node_id` | string | Yes |  |
| `prerelease` | enum: true | Yes | Whether the release is identified as a prerelease or a full release. |
