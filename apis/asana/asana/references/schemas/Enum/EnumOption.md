...
| `name` | string | No | The name of the enum option. |
| `enabled` | boolean | No | Whether or not the enum option is a selectable value for the custom field. |
| `color` | string | No | The color of the enum option. Defaults to `none`. |
