...
| `tags` | string[] | No |  |
| `redirect_uris` | string,null[] | Yes |  |
| `interactions_endpoint_url` | string,null (uri) | No |  |
| `role_connections_verification_url` | string,null (uri) | No |  |
| `owner` | [UserResponse](UserResponse.md) | Yes |  |
| `approximate_guild_count` | integer,null (int32) | No |  |
| `approximate_user_install_count` | integer (int32) | Yes |  |
| `approximate_user_authorization_count` | integer (int32) | Yes |  |
| `explicit_content_filter` | [ApplicationExplicitContentFilterTypes](ApplicationExplicitContentFilterTypes.md) | Yes |  |
| `team` | any | No |  |
