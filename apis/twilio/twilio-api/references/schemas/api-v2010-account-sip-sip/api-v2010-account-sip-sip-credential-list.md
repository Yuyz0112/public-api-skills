...
| `friendly_name` | string | No | A human readable descriptive text that describes the CredentialList, up to 64 characters long. |
| `sid` | string | No | A 34 character string that uniquely identifies this resource. |
| `subresource_uris` | object (uri-map) | No | A list of credentials associated with this credential list. |
