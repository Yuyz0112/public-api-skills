...
|-------|------|----------|-------------|
| `account_sid` | string | No | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the IpAccessControlListMapping resource. |
...
| `sid` | string | No | The unique string that that we created to identify the IpAccessControlListMapping resource. |
