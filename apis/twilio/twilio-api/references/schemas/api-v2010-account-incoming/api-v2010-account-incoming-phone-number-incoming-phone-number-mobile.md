...
| `address_requirements` | [incoming_phone_number_mobile_enum_address_requirement](incoming-phone-number-mobile-enum-address-requirement.md) | No |  |
...
| `voice_receive_mode` | [incoming_phone_number_mobile_enum_voice_receive_mode](incoming-phone-number-mobile-enum-voice-receive-mode.md) | No |  |
...
| `emergency_status` | [incoming_phone_number_mobile_enum_emergency_status](incoming-phone-number-mobile-enum-emergency-status.md) | No |  |
...
| `emergency_address_status` | [incoming_phone_number_mobile_enum_emergency_address_status](incoming-phone-number-mobile-enum-emergency-address-status.md) | No |  |
