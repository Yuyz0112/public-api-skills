...
| `address_requirements` | [incoming_phone_number_local_enum_address_requirement](incoming-phone-number-local-enum-address-requirement.md) | No |  |
...
| `voice_receive_mode` | [incoming_phone_number_local_enum_voice_receive_mode](incoming-phone-number-local-enum-voice-receive-mode.md) | No |  |
...
| `voice_url` | string (uri) | No | The URL we call when this phone number receives a call. The `voice_url` will not be used if a `voice_application_sid` or a `trunk_sid` is set. |
| `emergency_status` | [incoming_phone_number_local_enum_emergency_status](incoming-phone-number-local-enum-emergency-status.md) | No |  |
...
| `emergency_address_status` | [incoming_phone_number_local_enum_emergency_address_status](incoming-phone-number-local-enum-emergency-address-status.md) | No |  |
