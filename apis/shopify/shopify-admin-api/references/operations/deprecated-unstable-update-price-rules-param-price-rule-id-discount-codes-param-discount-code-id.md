...
**Operation ID:** `deprecated_unstable_update_price_rules_param_price_rule_id_discount_codes_param_discount_code_id`
...
| `discount_code_id` | path | string | Yes | discount_code_id |
