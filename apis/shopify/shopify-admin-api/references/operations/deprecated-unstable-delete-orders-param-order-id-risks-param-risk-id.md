...
**Resource:** [orders/order-risk](../resources/orders-order-risk.md)
**Deletes an order risk for an order
          
          
            Note
            You cannot delete an order risk that was created by another application.**
**Operation ID:** `deprecated_unstable_delete_orders_param_order_id_risks_param_risk_id`
...
| `risk_id` | path | string | Yes | risk_id |
