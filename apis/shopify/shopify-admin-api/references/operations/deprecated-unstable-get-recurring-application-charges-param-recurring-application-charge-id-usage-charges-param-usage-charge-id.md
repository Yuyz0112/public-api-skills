...
**Resource:** [billing/usagecharge](../resources/billing-usagecharge.md)
**Retrieves a single charge**
**Operation ID:** `deprecated_unstable_get_recurring_application_charges_param_recurring_application_charge_id_usage_charges_param_usage_charge_id`
...
| `usage_charge_id` | path | string | Yes | usage_charge_id |
